...
Talented school graduates from low-income families in Ukraine cannot afford quality higher education because there is no direct, trust-based mechanism connecting them with potential donors.

Existing paths fail:

- **Family support** — many families simply cannot afford it, especially after the full-scale invasion.
- **Grants and scholarships** — fragmented, complex to apply for, with low success rates.
- **Student loans** — barely developed in Ukraine, create long-term debt burden.
- **Working while studying** — reduces educational outcomes, forces students to postpone studies.
- **General crowdfunding platforms** (GoFundMe, etc.) — not adapted to Ukraine, do not guarantee that funds are actually spent on education.

The market for funding education is constrained not by a lack of capital, but by **information asymmetry** and the absence of a standardized, trust-based mechanism connecting donors with applicants.
...
If the funds are **not needed for tuition** — the applicant did not enroll, the campaign did not complete, or the person got a state-funded place or another grant — the donor's **pre-defined priority** applies:

1. Keep it for the student as a monthly stipend (housing, food, materials);
...
- Before publication, the team verifies: identity, NMT results, achievements, recommendations, social status.
...
2. Integration of a payment provider (LiqPay / WayForPay / Fondy) and an agreement with a partner bank for the escrow account.
3. Automated verification of admission status via EDEBO.
4. Development of a full backend (accounts, documents, mailings).
5. A first pilot campaign for 3–5 real applicants.
...
---
*Postup is a social startup. Our goal: that no talented applicant gives up on their education merely for lack of money.*
